...
\newcommand{\hell}{Melhoria de Processo de Software}		%nome do arquivo
% \renewcommand{\autor}{\ziul}							%criador do pdf - só observado nos detalhes do pdf
\newcommand{\assunto}{ ---}			%Nome do experimento
\newcommand{\ver}{Trabalho 3~- \assunto}						%numeração do experimento
\newcommand{\professor}{Fabiana Freitas Mendes}
